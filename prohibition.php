...
<head>
    ...
    <link rel="stylesheet" href="./dist/css/style_prohibition.css">
    <title>Document</title>
</head>
<body>
<div class="card" id="card_prohibition">
    <div class="card-body">
        <span class="card-title" id="card-title">Vous n'êtes pas Connecté</span>
        <div class="row">
            <div class="col-12">
